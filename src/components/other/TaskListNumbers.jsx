...
const TaskListNumbers = ({ data }) => {
  ...
  return (
    <div className="flex screen mt-10 justify-between overflow-x-auto gap-5">
      <div className="new1 rounded-xl py-6 px-9 p-10 w-[45%] bg-blue-400">
        <h2 className="text-2xl font-semibold">{counts.newTask}</h2>
        <h3 className="text-xl font-medium">New Task</h3>
      </div>
      <div className="new2 rounded-xl py-6 px-9 p-10 w-[45%] bg-green-400">
        <h2 className="text-2xl font-semibold">{counts.completed}</h2>
        <h3 className="text-xl font-medium">Completed Task</h3>
      </div>
      <div className="new3 rounded-xl py-6 px-9 p-10 w-[45%] bg-yellow-300">
        <h2 className="text-2xl text-white font-semibold">{counts.active}</h2>
        <h3 className="text-xl font-medium text-white">Active Task</h3>
      </div>
      <div className="new4 rounded-xl py-6 px-9 p-10 w-[45%] bg-red-400">
